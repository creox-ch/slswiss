...
| | |
|---|---|
| **Текущий спринт** | `forms-mvp-backend` (статус контракта `draft`) — доступен к работе |
| **✅ Готово (2026-06-29)** | `registration-fix` — регистрация рабочая end-to-end (Resend SMTP) |
...
- БЕЗ модерационного UI, БЕЗ авторизации (пишем от anon)
