...
**Дата:** 2026-07-01
**Статус:** ✅ **CLOSED 2026-07-01** — статьи в статус-модели, панель (автор+полный текст), публичный показ, E2E зелёные (БЛОК 21). ⏳ остаётся: автор видит статус статей в профиле (не реализовано, → follow-up).
