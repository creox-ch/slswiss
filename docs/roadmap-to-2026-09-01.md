...
| Дата | Что | Дней от 21.06 |
|---|---|---|
| **01.07.2026** | Регистрация пользователей открыта | 10 |
| **01.09.2026** | Платформа открыта для всех | 72 |
...
**10 спринтов в 10 недель = ноль резерва.**

В колонке Dev стоит 4 фазы, но внутри них 10+ функциональных задач. При темпе 1 спринт/неделю это означает что каждая фаза должна вмещать несколько мелких задач. Один срыв на 1 неделю = сдвиг 01.09.

Реалистичные сценарии:
1. **Ускорить темп до 2 спринтов/неделю** — нужен второй разработчик (Ivanna уже работает по сайтам — спросить её загрузку)
2. **Вынести часть за 01.09** — кандидаты на «после запуска»: `referral-program`, `user-content-moderation`, расширенный бизнес-тариф (150)
3. **Сократить scope MVP** — запустить 01.09 с урезанным функционалом, доделывать в сентябре
